...
public class Main {
    public static void main(String[] args) {
        ...
        // Fornece ao usuario a oportunidade de escolher ou nao converter um valor especifico
        ...
        if (querConverter == 's') {
            ...
            System.out.print("Digite o número da moeda estrangeira: ");
            moedaEscolhida = scanner.nextInt();

            System.out.print("Digite o valor em R$: ");
            float valorEmReais = (float) scanner.nextDouble();
